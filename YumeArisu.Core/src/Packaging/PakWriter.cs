...
{
    public readonly struct WriteProgress
    {
    ...
    public static void Pack(string rootFolderPath, string outputFolderPath, string outputName = null, Action<WriteProgress> progressAction = null)
    {
        // 경로 정규화: 트레일링 슬래시 통일
        ...
        while (sortedSmallFiles.Count > 0)
        {
            ...
            WriteSmallPakFile(currentChunkOrder, rootFolderPath, pakPath, ref sortedSmallFiles, 
                ...
                {   
                    processedCount++;
                    progressAction?.Invoke(new WriteProgress 
                    { 
