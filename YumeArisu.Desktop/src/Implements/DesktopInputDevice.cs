...
using DesktopKeyboardState = YumeArisu.Desktop.Internal.KeyboardState;
using DesktopMouseState = YumeArisu.Desktop.Internal.MouseState;
...
public class DesktopInputDevice : IInputSource
{
    ...
    private DesktopKeyboardState _keyboardState;
    private DesktopMouseState _mouseState;
    ...
    public DesktopInputDevice(IView view)
    {
        ...
        _keyboardState = new DesktopKeyboardState(_input.Keyboards[0]);
        _mouseState = new DesktopMouseState(_input.Mice[0]);
    }
